...
bool min_y_point_initialized = false;
...
*/
    ...
    if (!cloud_non_ground->points.empty()) {
        ...
        min_y_point_initialized = true; // 表示min_y_point已初始化
    }
